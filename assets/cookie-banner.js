    ...
    function renderBanner(settingsMode) {
        ...
        if (simpleMode) {
            ...
            txt.innerHTML = 'Usamos cookies essenciais para o funcionamento do site e, '
                ...
                + '<a href="documentos-termos.html" style="color:#59FD27;">Saiba mais</a>.';
            ...
            var btnAccept = el('button', {
                type: 'button',
                style: 'background:#59FD27;color:#0A0A0A;border:none;'
            ...
            function row(id, label, hint, locked, checked) {
                ...
                if (locked) {
                    inp.checked = true;
                    inp.disabled = true;
                    inp.style.cssText = 'accent-color:#59FD27;opacity:0.6;margin-top:3px;';
                } else {
                    inp.checked = !!checked;
                    inp.style.cssText = 'accent-color:#59FD27;margin-top:3px;';
                }
