...
(function () {
  ...
  window.BLAXX_APP_BUILD = 'b2b-recolhido-2026-09-02';
  ...
  function maybeShowSetPasswordBanner() {
    ...
    bar.style.cssText =
      'position:sticky;top:0;z-index:50;background:#0B1820;color:#59FD27;' +
  ...
  function initDashboard() {
    ...
    fab.style.cssText =
      ...
      'background:#080907;color:#59FD27;border:0;border-radius:50%;font-size:24px;' +
    ...
    api('/campaigns/').then(function (d) {
      ...
      container.innerHTML = items.map(function (c) {
        ...
        return '<div class="bx-camp-card" style="padding:14px;border:1px solid #eee;border-radius:12px;margin:8px;">'
          ...
          + (c.joined ? '<div style="height:8px;background:#eee;border-radius:99px;"><div style="height:100%;width:' + pct + '%;background:#59FD27;border-radius:99px;"></div></div><small>' + pct + '%</small>' : '')
  ...
  function bxRenderError(opts) {
    ...
    var btn = '<button type="button" id="' + btnId + '" ' +
      'style="background:var(--lime,#59FD27);color:var(--ink,#080907);border:0;padding:10px 20px;' +
