...
const CACHE = 'blaxx-v32-novos-destinos';
const PRECACHE = [
  '/',
  '/login.html',
  '/cadastro.html',
...
h1{color:#59FD27;margin:0 0 12px;}
p{color:#8a918a;line-height:1.6;}
button{background:#59FD27;color:#080907;border:0;padding:12px 24px;border-radius:999px;font-weight:700;font-size:14px;cursor:pointer;margin-top:16px;}
</style></head>
<body><div class="card">
<h1>Sem internet</h1>
...
self.addEventListener('push', (ev) => {
  let data = { title: 'BlaXx', body: 'Voce tem uma novidade.' };
  if (ev.data) {
