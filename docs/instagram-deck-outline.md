...
- **Metas realistas:** 30 dias = 5k–15k · 60 dias = 20k–50k · 90 dias = 50k–150k
- **Para mirar 1M de verdade:** orçamento de mídia (R$ 50k–200k+/mês), criadores grandes simultâneos, mecânica de sorteio "convide amigos".
...
- **Mãe organizadora das finanças:** estica o dinheiro da casa → pontos do dia a dia viram Pix.
- **Trocador de milhas/pontos:** odeia ponto que não usa → liquidez real em Pix.
- **Indicador social:** adora compartilhar → indique-e-ganhe + enviar pontos.

> Mapear = definir QUEM mirar via segmentação de anúncios e parcerias. **NÃO** é raspar perfis (proibido pela Meta e LGPD).
...
- **12 roteiros de Reels**, **7 carrosséis**, **16 ganchos para teste A/B**, legendas e bio.
- Exemplos de Reels: "Você tá deixando dinheiro na mesa" · "Mandei pontos pro meu irmão pagar a pizza" · "Quanto juntei só comprando o de sempre".
- **O gancho dos 3 primeiros segundos decide o alcance.**
...
- **Frequência:** semanal → loop de novos seguidores.
- ⚠️ **Atenção legal:** pode exigir autorização SECAP/Ministério da Fazenda; avaliar formato de concurso cultural; conformidade LGPD; frase de isenção da Meta obrigatória. **Validar com jurídico.**

---

## Calendário editorial

- **Cadência:** 1 Reel/dia + 3–4 carrosséis/semana + Stories diários.
- Gancho nos **3 primeiros segundos**.
- Reels curtos = alcance · carrosséis = salvamento.
- **Responder comentários na 1ª hora.**
- Reaproveitar o que funcionou como **anúncio**.
- Repostar no **TikTok e Kwai** (alcance grátis extra).
...
## Métricas que importam (não vaidade)

- **Alcance de não-seguidores** → viralidade.
- **Salvamentos + compartilhamentos** → sinal nº 1 do algoritmo.
- **Custo por seguidor** no pago → eficiência.
- **Cliques no link / cadastros** → o que importa pro negócio.
- **Retenção do Reel** → qualidade do gancho.

> Curtidas são vaidade. Foque no que paga conta.

---

## Próximos passos & limites

- **Dá pra fazer:** mais conteúdo, copy de anúncios, regulamento do sorteio, este deck.
- **Não fazemos:** acessar/postar na conta automaticamente, raspar seguidores, garantir números.
- **Execução** (postar, mídia paga, parcerias, dados reais) é da equipe.
</content>
