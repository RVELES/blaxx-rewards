...
## ⚠️ Leia antes: a meta de 1.000.000 em 3 meses

Sendo honesto e direto, para não te vender ilusão:

- **1M de seguidores em 90 dias é praticamente inalcançável por orgânico** para uma conta nova de um programa de pontos. Contas que crescem nesse ritmo quase sempre têm: (a) tráfego pago pesado, (b) um ou mais Reels que estouram (milhões de views), (c) sorteios virais com co-patrocínio, ou (d) parcerias com criadores que já têm milhões.
- **Meta realista, agressiva mas possível, com investimento e execução boa:**
...
Ganhe nas compras → troque por dinheiro
Envie pontos pra qualquer um • Resgate com parceiros
👇 Comece grátis
[link]
```
...
## 2. Mapa de público (personas)

> "Mapear usuários" aqui = definir QUEM mirar e ONDE encontrá-los via segmentação de anúncios e parcerias. **Não** é raspar perfis de seguidores (ilegal pela Meta e LGPD).

| Persona | Quem é | Dor | Gancho da BlaXx | Onde mirar |
|---|---|---|---|---|
| **Caçador de cashback** | 22–35, urbano, já usa Méliuz/Inter/Nubank | "Quero o máximo de volta em tudo" | Pontos viram Pix, não crédito travado | Interesses: cashback, milhas, finanças pessoais |
| **Jovem apertado** | 18–28, estudante/1º emprego | "Todo real conta no fim do mês" | Ganha grátis no que já compra | Lookalike, criadores de "economia/dinheiro" |
| **Mãe organizadora das finanças** | 30–45, gerencia o orçamento da casa | "Quero esticar o dinheiro da família" | Pontos do dia a dia → Pix pra contas | Interesses: cupons, mercado, maternidade |
| **Trocador de milhas/pontos** | 28–50, otimiza programas | "Pontos que não consigo usar são lixo" | Liquidez real: vira Pix quando quiser | Grupos de milhas, fóruns, criadores de viagem |
| **Indicador social** | qualquer idade, compartilha tudo | "Ganhar indicando amigos" | Indique-e-ganhe + enviar pontos | Mecânica de sorteio "marque amigos" |

**Estratégia de aquisição por camadas:**
1. **Orgânico (Reels):** alcance frio amplo → topo de funil.
2. **Parcerias com micro-criadores** (10k–100k) de finanças/economia → confiança + público qualificado. Custo-benefício muito melhor que 1 criador gigante.
3. **Tráfego pago** (Reels que já performaram organicamente → impulsionar) → escala previsível.
4. **Sorteio viral** com mecânica "siga + marque 3 amigos + salve" → loop de crescimento.
...
4. Resgate com parceiros → economize
5. Troque pontos por Pix → dinheiro na conta
...
#cashback #financaspessoais #dinheiro #economia #pix #pontos
```
...
## 6. Calendário editorial (cadência mínima viável)

**Frequência alvo:** 1 Reel/dia + 3–4 carrosséis/semana + Stories diários.

| Dia | Feed | Stories |
|---|---|---|
| Seg | Reel (prova: pontos→Pix) | Bastidores + enquete |
| Ter | Carrossel (hack/lista) | Recap do Reel + CTA link |
| Qua | Reel (trend-jacking) | Caixinha de perguntas |
| Qui | Carrossel (educação) | Print de Pix de usuário (UGC) |
| Sex | Reel (social/UGC) | Sorteio da semana |
| Sáb | Reel leve/humor | Resultados + repost |
| Dom | Carrossel (resumo/autoridade) | Enquete "qual conteúdo quer?" |

**Regras de ouro do algoritmo (2026):**
- Os 3 primeiros segundos definem tudo. Gancho forte ou morre.
- Reels curtos (7–15s) para alcance; carrosséis para salvamento/retenção.
- Responder TODO comentário na 1ª hora (sinal de engajamento).
- Reaproveitar o que funcionou: o Reel que bate a média vira anúncio.
- Postar o mesmo conteúdo no TikTok e Kwai (mesmo público, alcance grátis extra).
...
- Meta: 50k–150k (estouro de Reel pode multiplicar).

---

## 8. Métricas que importam (não vaidade)

- **Alcance de não-seguidores** (% ) → indica viralidade.
- **Salvamentos + compartilhamentos por post** → sinal nº 1 do algoritmo.
- **Custo por seguidor (CPF)** no pago → eficiência de escala.
- **Cliques no link / cadastros** → o que realmente importa pro negócio.
- **Taxa de retenção do Reel** (assistiu até o fim) → qualidade do gancho.

> Vaidade (curtidas) não paga conta. Foque em salvamento, compartilhamento e cadastro.

---

## 9. O que eu (Claude) posso fazer pra ajudar daqui pra frente
...
**O que eu NÃO faço:** acessar/postar na conta, seguir/mandar DM, raspar seguidores, ou garantir números. Execução e dados reais ficam com a equipe.
</content>
</invoke>
